...
- **iPhone 11 / iOS 14, Save does not download** — Safari ignores the `download` attribute. The link opens the file in a new tab; use Share → Save to Files. Video and audio do not preview inline on iOS 14 (no service worker); images do.
